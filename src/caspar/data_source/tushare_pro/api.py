...
from .model import TushareResponse, TushareResponseError
    ...
    async def stock_basic(
        ...
        *,
        ...
        Args:
            ...
            market (str, optional): 市场类别 （主板/创业板/科创板/CDR/北交所）. Defaults to None.
            list_status (str, optional): 上市状态 L上市 D退市 P暂停上市，默认是L. Defaults to None.
            exchange (str, optional): 交易所 SSE上交所 SZSE深交所 BSE北交所. Defaults to None.
            is_hs (str, optional): 是否沪深港通标的，N否 H沪股通 S深股通. Defaults to None.
        """
        pass
...
class TushareProAPI(TushareProAPIBase):
    ...
    async def query(self, api_name: str, fields: str = "", **kwargs) -> TushareResponse:
        ...
        async with self.__session.post(
            self.__base_url, json=req_params, timeout=self.__timeout
        ) as res:
    ...
    def __getattribute__(self, item):
        if not item.startswith("__") and hasattr(TushareProAPIBase, item):
